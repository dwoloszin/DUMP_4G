...
def processArchive():
  ...
  cmd = 'cmedit get * Slot.(productData) -t'
  columnsMask = ['NodeId','drop1','drop2','drop3','productData']
  pathToSave = 'HW'
  ArchiveName = 'DU_1'
...
def tratarArchive(frameSI):  
  ...
  frameSI = frameSI.drop(['productData','SHORT','productNumber','productRevision'],1)
